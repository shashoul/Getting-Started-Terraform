resource "datadog_logs_custom_pipeline" "bindid_authentication_server_csv" {

  name       = "bindid-authentication-server_csv"
  is_enabled = true
  filter {
...
EOF
  ...
  #     target = "api_audience"
  #     dynamic "category" {
  #       # for_each = var.api_audience_categories
  #       for_each = local.api_audience_categories
  #       content {
  #         filter {
  #           query = category.value.filter_query
  #         }
  ...
  #     is_enabled = true
  #     dynamic "category" {
  #       for_each = local.error_categories
  #       content {
  #         filter {
  #           query = category.value.filter_query
  #         }
