...
def get_arguments():
    ...
    parser.add_argument("--type", "-t", choices=["dashboard","monitor","synthetics","pipeline","logmetrics"], required=False, default="dashboard", help="The type of datadog object the json represents.")
