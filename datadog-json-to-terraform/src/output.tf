resource "datadog_dashboard" "dashboard_1" {
  ...
  created_at    = "2021-04-19T13:04:19.190916+00:00"
  modified_at   = "2021-04-20T08:34:03.719370+00:00"
  author_handle = "silina@transmitsecurity.com"
  widget {
...
resource "datadog_dashboard" "dashboard_3" {
  ...
  notify_list   = []
  description   = ""
  author_name   = "Chris Corpuz"
  is_read_only  = false
  title         = "Sandbox Uptime Service Dashboard"
  url           = "/dashboard/y3f-8ai-pbm/sandbox-uptime-service-dashboard"
  created_at    = "2021-01-26T16:08:44.808402+00:00"
  modified_at   = "2021-05-11T10:30:15.038555+00:00"
  author_handle = "chris.corpuz@transmitsecurity.com"
  widget {
...
resource "datadog_dashboard" "dashboard_5" {
  ...
  created_at    = "2021-05-11T10:16:20.872327+00:00"
  modified_at   = "2021-05-11T10:28:29.889207+00:00"
  author_handle = "chris.corpuz@transmitsecurity.com"
  widget {
    service_level_objective_definition {
      time_windows      = ["7d", "week_to_date", ]
...
resource "datadog_dashboard" "dashboard_6" {
  ...
  created_at    = "2021-02-01T15:04:43.428503+00:00"
  modified_at   = "2021-02-11T14:56:38.364900+00:00"
  author_handle = "chris.corpuz@transmitsecurity.com"
  widget {
    timeseries_definition {
      title_size = "16"
...
resource "datadog_dashboard" "dashboard_7" {
  ...
  created_at    = "2021-04-09T09:52:50.942166+00:00"
  modified_at   = "2021-04-09T09:56:04.604593+00:00"
  author_handle = "tomer@transmitsecurity.com"
  widget {
    geomap_definition {
      style {
...
EOF
  ...
  created_at    = "2021-01-21T12:30:01.773280+00:00"
  modified_at   = "2021-01-27T00:05:14.537771+00:00"
  author_handle = "chris.corpuz@transmitsecurity.com"
  widget {
...
resource "datadog_dashboard" "dashboard_10" {
  ...
  notify_list   = []
  description   = null
  author_name   = "Shahd Krayem"
  is_read_only  = false
  title         = "Infrastructure Overview"
  url           = "/dashboard/nh8-bzn-8ck/infrastructure-overview"
  created_at    = "2021-01-12T06:23:07.648498+00:00"
  modified_at   = "2021-02-24T15:59:02.022744+00:00"
  author_handle = "shahd@transmitsecurity.com"
  widget {
    free_text_definition {
      color      = "#4d4d4d"
      text       = "Mongo DB "
...
resource "datadog_dashboard" "dashboard_11" {
  ...
  created_at    = "2021-03-17T12:37:29.596887+00:00"
  modified_at   = "2021-03-17T12:42:14.583329+00:00"
  author_handle = "chris.corpuz@transmitsecurity.com"
  widget {
    event_stream_definition {
      title_size     = "16"
...
resource "datadog_dashboard" "dashboard_13" {
  ...
  created_at    = "2021-01-27T11:32:27.250576+00:00"
  modified_at   = "2021-01-28T11:45:49.158924+00:00"
  author_handle = "shahd@transmitsecurity.com"
  widget {
    note_definition {
      tick_pos         = "50%"
...
EOF
  ...
  created_at    = "2021-01-27T10:51:51.084682+00:00"
  modified_at   = "2021-01-27T11:31:43.289714+00:00"
  author_handle = "shahd@transmitsecurity.com"
  widget {
    query_value_definition {
      title_size  = "13"
...
EOF
  ...
  created_at    = "2021-01-18T15:07:50.850302+00:00"
  modified_at   = "2021-01-18T15:07:50.850302+00:00"
  author_handle = "shahd@transmitsecurity.com"
  widget {
    toplist_definition {
      title_size  = "16"
...
EOF
  ...
  created_at    = "2021-01-18T12:25:51.826447+00:00"
  modified_at   = "2021-01-18T12:25:51.826447+00:00"
  author_handle = "shahd@transmitsecurity.com"
  widget {
    event_stream_definition {
      title_size     = "13"
...
EOF
  ...
  created_at    = "2021-01-17T13:33:30.248673+00:00"
  modified_at   = "2021-01-17T13:33:30.248673+00:00"
  author_handle = "shahd@transmitsecurity.com"
  widget {
    timeseries_definition {
      title_size  = "16"
...
EOF
  ...
  created_at    = "2021-01-12T07:02:29.026773+00:00"
  modified_at   = "2021-01-12T07:02:29.026773+00:00"
  author_handle = "shahd@transmitsecurity.com"
  widget {
    query_value_definition {
      autoscale   = true
...
EOF
  ...
  created_at    = "2020-09-23T13:47:45.153906+00:00"
  modified_at   = "2020-09-23T13:47:45.153906+00:00"
  author_handle = "chris.corpuz@transmitsecurity.com"
  widget {
    timeseries_definition {
      title_size  = "16"
...
resource "datadog_dashboard" "dashboard_21" {
  ...
  created_at    = "2020-08-10T15:13:24.517663+00:00"
  modified_at   = "2020-08-10T15:13:24.517663+00:00"
  author_handle = "elad.azary@transmitsecurity.com"
  widget {
    timeseries_definition {
      yaxis {
      }
